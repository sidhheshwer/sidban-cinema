...
public class SidbanTopService {
   ...
   private RestTemplate restTemplate;
       ...
       public SidbanTopService(RestTemplate restTemplate) {
        this.restTemplate = restTemplate;
    }

    public ResponseEntity<?> sidbanTopService(int page) {
...
String url =
    "https://api.themoviedb.org/3/movie/top_rated?api_key="
        ...
        try {
            ...
            System.out.println("Fetching page " + page + " from TMDB...");
